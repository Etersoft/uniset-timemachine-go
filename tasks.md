...
- Диагностический тест `index.test.js` убран; вместо него можно включать режим диагностики в UI и выгружать лог.
...
- ✅ UI-полировка: статус/чипы унифицированы, заголовок Player · v2, вкладка «Датчики», поле «Кэш» (15s), подсказки датчиков без дублей, легенда с фиксированной шириной значения, лог с меньшими контролами.
...
5. ✅ Синхронизация: пауза не жрёт CPU, шаги/seek обновляют pending и таймлайн; step доступен даже после Stop (через pending seek).
6. ⚠ Тесты/доки: добавить smoke/flow для графиков, обновить README/DOCS с зависимостью Chart.js, подсказками и описанием кнопок/диапазона.
