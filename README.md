...
Встроенный UI доступен по адресу `/ui/` и позволяет управлять воспроизведением через браузер.
...
- Виртуальный скроллинг — эффективная работа с большим количеством датчиков
- Фильтрация по имени и описанию
- Подсветка изменившихся значений
- Добавление датчиков на график одним кликом

### Графики

![Графики](docs/screenshots/07-charts-with-sensor.png)

- Автообновление при воспроизведении
